...
Throughout my degree, I've had the opportunity to learn and work on projects using C, Java, Python, C#, and Bash scripting, covering a wide range of areas — from prototyping in Figma and Android application development to compiler design, shell implementation, Docker deployments, and more.
